...
INSERT INTO `admin` VALUES (1,'yusufozturk','thelordbelial@hotmail.com','yusuf');
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ucak` (
  `iducak` int NOT NULL AUTO_INCREMENT,
  `kalkis` varchar(45) NOT NULL,
  `inis` varchar(45) NOT NULL,
...
INSERT INTO `ucak` VALUES (8,'Ankara','Van','22/01/2020');
...
INSERT INTO `userr` VALUES (3,'ali','ali@hotmail.com','yusuf'),(6,'aa','aa','aa'),(9,'aa','aa','aa'),(10,'a','aa','aaa'),(12,'aa','aa','aa');
...
-- Dump completed on 2021-02-09 15:41:08
